...
if __name__ == '__main__':
    ...
    # findings: for this exact file, it won't work
    # test with another one!!! - from PyEvolve tests
    # print("res: ",
    ...
    # TODO: is type_infer.py needed here? (probably yes)
    print("Db path: ", cf.DATABASE_PATH)
    print("res: ", pyevolve_facade.run_pyevolve())
    # print("res: ", pyevolve_facade.run_pyevolve_transform(cf.PROJECT_REPO, cf.TYPE_REPO, cf.FILES_PATH, cf.RULES_PATH))
